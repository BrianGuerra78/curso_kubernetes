package org.bguerra.springcloud.msvc.usuarios.controllers;

import org.bguerra.springcloud.msvc.usuarios.models.entity.Usuario;
import org.bguerra.springcloud.msvc.usuarios.services.UsuarioService;
       ...
       // if (!usuario.getEmail().isEmpty() && service.porEmail(usuario.getEmail()).isPresent()) {
        if (!usuario.getEmail().isEmpty() && service.existePorEmail(usuario.getEmail())) {
            return ResponseEntity.badRequest()
                    .body(Collections.
                            singletonMap("mensaje", "Ya existe un usario con ese correo electronico!"));
        }
        return ResponseEntity.ok().body(service.guardar(usuario));
    }
